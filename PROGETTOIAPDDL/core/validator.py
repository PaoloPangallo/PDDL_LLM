...
if __name__ == "__main__":
    import json
    domain_path = "uploads/lore-generated/domain.pddl"
    problem_path = "uploads/lore-generated/problem.pddl"
    ...
    plan_report = generate_plan_with_fd(domain_content, problem_content)
