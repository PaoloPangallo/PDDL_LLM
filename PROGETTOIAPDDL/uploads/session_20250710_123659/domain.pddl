(define (domain dragon-quest)
  ...
  (:action explore
    ...
    :precondition (and (at ?h ?l) (eligible_explore ?l) (not (explored ?l)))
  ...
  (:action defeat-dragon
    :parameters (?h - agent ?d - monster ?l - location ?a - artifact)
    :precondition (and (at ?h ?l) (explored ?l) (has ?h ?a))
